...
The visual language is a dark technical workspace — near-black backgrounds, layered surfaces, and vivid accent colors for interactive elements.
...
Tailwind utility names map to these variables. Use:
...
Never use raw Tailwind colors or hex values.
...
8 defined color pairs. Each pair specifies a dark node fill and a vivid contrasting text color tuned for readability on the dark canvas.
