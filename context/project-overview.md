...
- Real-time collaboration on system design  
...
- Infrastructure provisioning (e.g., Terraform, AWS setup)  
- Advanced version control for designs (v1 can be simple snapshots)  
